      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">
            Hãy đặt lịch thuê thiết bị để bắt đầu
          </p>
          <Button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {bookings.map((booking) => (
              <div
                key={booking.equipment.equipmentId}
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2">
                      {booking.equipment.categoryName}
                    </p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="text-sm space-y-1">
                        <p className="text-gray-600">
                          Giá thuê: {formatCurrency(booking.totalPrice)}
                        </p>
                        <p className="text-gray-600">
                        ...
                        {booking.insuranceFee > 0 && (
                          <p className="text-gray-600">
                            Bảo hiểm: {formatCurrency(booking.insuranceFee)}
                          </p>
                        )}
                      </div>
                      <button
                        onClick={() =>
                          removeBooking(booking.equipment.equipmentId)
                        }
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6 sticky top-4">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-orange-600">
                    {formatCurrency(getTotalDeposit())}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="border-t pt-3 flex justify-between text-lg font-bold">
                  ...
                  <span className="text-green-600">
                    {formatCurrency(getTotalPrice() + getTotalDeposit())}
                  </span>
                </div>
              </div>
              ...
              <p className="text-xs text-gray-500 mt-4 text-center">
                Bạn sẽ được chuyển đến trang quản lý đơn thuê sau khi tạo thành
                công
              </p>
            </div>
          </div>
